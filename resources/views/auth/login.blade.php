<x-layout>
    <form action="{{ route('login') }}" method="POST" class="max-w-sm mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-200">
        @csrf
  
        <h2 class="text-2xl font-semibold text-gray-800 mb-6 text-center">Log In to Your Account</h2>
